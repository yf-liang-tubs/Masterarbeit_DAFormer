...
HRDA_gta= torch.load(HRDA_checkpoint_path, map_location=device)
encoder_HRDA_gta={}
...
HRDA_gta = BACKBONES.get('mit_b5')(init_cfg = dict(type='Pretrained'))
HRDA_gta.load_state_dict(encoder_HRDA_gta)
HRDA_gta = HRDA_gta.to(device)
HRDA_gta.eval()
...
layer_names = []
for name, module in HRDA_gta.named_modules():
...
extracted_features_HDRA = activate_and_extract_features(HRDA_gta, gta5_dataloader, layer_names)

torch.save(extracted_features_HDRA, '/home/yliang/work/DAFormer/save_file/similarity_comparision_new/1_activation_feature/gta5/0_f1_f2_f3_f4_other_lowest_point/hrda_lowpoints_batch500.pt')
print('Saved: extracted_features')



# conv = torch.load('/home/yliang/work/DAFormer/save_file/similarity_comparision_new/1_activation_feature/gta5/4_conv_layers_only/HDRA_dwconv_batch500.pt',map_location='cpu')