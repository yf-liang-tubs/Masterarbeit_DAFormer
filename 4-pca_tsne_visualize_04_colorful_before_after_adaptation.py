...
# 使用函数处理不同的数据集和特征
selected_labels_1, x_1, y_1, point_colors_1 = process_data('200', '2000',dataset='gta5',model='baseline' ,layer='f4')

selected_labels_2, x_2, y_2, point_colors_2 = process_data('200', '2000',dataset='cityscapes', model='baseline' ,layer='f4')
