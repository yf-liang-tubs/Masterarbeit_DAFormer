...
# 使用函数处理不同的数据集和特征
selected_labels_1, x_1, y_1, point_colors_1 = process_data(per, niter,model='baseline', layer='f4', dataset='cityscapes')
selected_labels_2, x_2, y_2, point_colors_2 = process_data(per, niter,model='baseline', layer='f4', dataset='gta5')
...
plt.savefig(f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/plot/bl_gta5_cs.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
