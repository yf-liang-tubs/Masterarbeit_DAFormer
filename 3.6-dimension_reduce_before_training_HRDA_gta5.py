...
activata_feature_tensor2_file ='/home/yliang/work/DAFormer/save_file/before_training_feature/GTA5/f4_tensor_GTA5.pt'
...
#save
torch.save(reduced_selected_pixel_1, f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_gta5_CS_tensor.pt')
torch.save(reduced_selected_pixel_2, f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_gta5_GTA5_tensor.pt')
print('pixels saved')

np.save(f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_gta5_CS_selected_label.npy', selected_labels_1)
np.save(f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_gta5_GTA5_selected_label.npy', selected_labels_2)
print('labels saved')
