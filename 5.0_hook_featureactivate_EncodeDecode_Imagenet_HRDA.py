...
hrda_decode_encode.to(device)
hrda_decode_encode.eval()
...
layer_names = []
for name, module in hrda_decode_encode.named_modules():
    print(name)
...
extracted_features_HDRA = activate_and_extract_features(hrda_decode_encode, dataset_dataloader, layer_names)
torch.save(extracted_features_HDRA, f'/home/yliang/work/DAFormer/save_file/encode_decode_feature/Imagnet_HRDA/synthia_decode_head.fuse_layer.bottleneck.bn_batch500.pt')
