...
torch.save(extracted_features_baseline, f'/home/yliang/work/DAFormer/save_file/encode_decode_feature/Imagnet_BL/gta5/3.pt')
print('Saved: extracted_features')
'''

#contacte feature----------------------------------------------------
extracted_features_1 = torch.load('/home/yliang/work/DAFormer/save_file/encode_decode_feature/Imagnet_BL/gta5/1.pt', map_location=device)
cat_1= extracted_features_1['decode_head.linear_fuse.bn']
del extracted_features_1


extracted_features_2 = torch.load('/home/yliang/work/DAFormer/save_file/encode_decode_feature/Imagnet_BL/gta5/2.pt', map_location=device)
cat_2= extracted_features_2['decode_head.linear_fuse.bn']
del extracted_features_2

extracted_features_3 = torch.load('/home/yliang/work/DAFormer/save_file/encode_decode_feature/Imagnet_BL/gta5/3.pt', map_location=device)
cat_3= extracted_features_3['decode_head.linear_fuse.bn']
del extracted_features_3

merged_list = cat_1 + cat_2 + cat_3 

result_tensor_cs = torch.cat(merged_list, dim=0)
print(f'size:{result_tensor_cs.size()}')
concatenated_tensor_cs = result_tensor_cs.permute(0, 2, 3, 1)
torch.save(concatenated_tensor_cs, '/home/yliang/work/DAFormer/save_file/encode_decode_feature/Imagnet_BL/gta5/gta5_concat_decode_head.concatenated_tensor_batch500.pt')
print('save gta5')
