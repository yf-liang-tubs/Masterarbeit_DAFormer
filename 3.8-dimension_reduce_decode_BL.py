...
activata_feature_tensor1_file ='/home/yliang/work/DAFormer/save_file/encode_decode_feature/baseline/cs/cs_concat_decode_head.concatenated_tensor_batch500.pt'
activata_feature_tensor2_file ='/home/yliang/work/DAFormer/save_file/encode_decode_feature/baseline/gta5/gta5_concat_decode_head.concatenated_tensor_batch500.pt'
...
#save
torch.save(reduced_selected_pixel_1, '/home/yliang/work/DAFormer/save_file/encode_decode_feature/baseline/pixel_label/cs_decode_head.concatenated_500_tensor.pt')
torch.save(reduced_selected_pixel_2, '/home/yliang/work/DAFormer/save_file/encode_decode_feature/baseline/pixel_label/gta5_decode_head.concatenated_500_tensor.pt')
print('pixels saved')

np.save('/home/yliang/work/DAFormer/save_file/encode_decode_feature/baseline/pixel_label/cs_decode_head.concatenated_500_selected_label.npy', selected_labels_1)
np.save('/home/yliang/work/DAFormer/save_file/encode_decode_feature/baseline/pixel_label/gta5_decode_head.concatenated_500_selected_label.npy', selected_labels_2)
print('labels saved')


#test
label_tensor_1 = torch.load(label_tensor2_file, map_location=device)
# 将张量转换为 NumPy 数组
array = label_tensor_1.numpy()

# 检查数字 18 是否在数组中，并计算出现次数
count_18 = np.sum(array == 18)

if count_18 > 0:
    print(f"数字 18 在张量中出现了 {count_18} 次。")
else:
    print("数字 18 不在张量中。")