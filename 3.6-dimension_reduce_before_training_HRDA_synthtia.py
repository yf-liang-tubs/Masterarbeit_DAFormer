...
activata_feature_tensor1_file ='/home/yliang/work/DAFormer/save_file/before_training_feature/CS/f4_tensor_CS.pt'
activata_feature_tensor2_file ='/home/yliang/work/DAFormer/save_file/before_training_feature/SYNTHIA/f4_tensor_SYNTHIA.pt'
...
#save
torch.save(reduced_selected_pixel_1, f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_synthia_CS_tensor.pt')
torch.save(reduced_selected_pixel_2, f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_synthia_SYNTHIA_tensor.pt')
print('pixels saved')

np.save(f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_synthia_CS_selected_label.npy', selected_labels_1)
np.save(f'/home/yliang/work/DAFormer/save_file/before_training_feature/visiualize/per{per}_iter{niter}/f4_HRDA_synthia_SYNTHIA_selected_label.npy', selected_labels_2)
print('labels saved')
